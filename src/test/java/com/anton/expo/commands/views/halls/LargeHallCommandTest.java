...
class LargeHallCommandTest {
    ...
    LargeHallCommand largeHallCommand;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.initMocks(this);
        largeHallCommand = new LargeHallCommand(expositionService, hallService);
        when(request.getSession()).thenReturn(session);
    }

    @Test
    void largeHallPageTest() throws Exception {
        Hall hall = new Hall();
        ...
        String[] hallPage = largeHallCommand.process(request, response);
