...
class SmallHallCommandTest {
    private static final String URI = "/smallHall";
    @Mock
    ...
    SmallHallCommand smallHallCommand;

    @BeforeEach
    void setUp() {
        MockitoAnnotations.initMocks(this);
        smallHallCommand = new SmallHallCommand(expositionService, hallService);
        when(request.getSession()).thenReturn(session);
    }

    @Test
    void smallHallPageTest() throws Exception {
        Hall hall = new Hall();
        ...
        String[] hallPage = smallHallCommand.process(request, response);
